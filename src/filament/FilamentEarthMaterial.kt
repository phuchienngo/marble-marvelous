...
internal object FilamentEarthMaterial {
  ...
  fun createCloudShell(
    context: Context,
    engine: Engine
  ): Material = FilamentMaterialLoader.load(context, engine, CLOUD_SHELL_ASSET_PATH)

  const val ASSET_PATH: String = "filament/earth.filamat"
  const val CLOUD_SHELL_ASSET_PATH: String = "filament/cloud-shell.filamat"
