...
open class BaseWallpaperEngine(
  ...
  @JvmField
  protected var screenSize: Size? = null
  ...
  @JvmField
  protected var screenRotation = 0.0f
  ...
  @JvmField
  protected var pageSwipeController = PageSwipeController()
  ...
  override fun render() {
    if (initialized) {
      ...
      val delta: Float =
        BaseMathUtils.clamp((currentTimeNanos - lastTimeNanos) / 1.0E9f, 0.0f, 1.0f)
