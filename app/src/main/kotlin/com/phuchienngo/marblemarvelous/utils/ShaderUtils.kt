...
object ShaderUtils {
  ...
  fun loadShaderWithMethods(
    ...
    val shaderContent: String =
      replaceShaderMethods(loadShader(shaderPath), methodsToAdd.toString())
  ...
  @JvmStatic
  fun load(basePath: String): ShaderProgram =
    load(loadVertexShader(basePath), loadFragmentShader(basePath))
