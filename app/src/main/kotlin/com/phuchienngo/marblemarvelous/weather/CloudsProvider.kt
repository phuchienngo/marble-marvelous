...
class CloudsProvider(
  ...
  constructor(
    ...
    private fun uploadFace(
      ...
      RandomAccessFile(
        file,
        READ_ONLY_MODE
      ).use uploadRawFace@{ randomAccessFile: RandomAccessFile ->
  ...
  constructor(
    ...
    fun create(callback: Callback): CloudsProvider =
      CloudsProvider(context, openWeatherClouds, apiKey, mainDispatcher, callback)
  }
