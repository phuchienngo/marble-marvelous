...
class ScreenRotationController @Inject constructor(context: Context, private val listener: ScreenOrientationListener) {
    ...
    private class DisplayOrientationListener(controller: ScreenRotationController) :
    ...
    fun updateRotation() {
        val rotationTmp: ScreenRotation = when (displayManager.getDisplay(Display.DEFAULT_DISPLAY)?.rotation) {
