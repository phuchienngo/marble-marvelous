...
class UserPresenceController @Inject constructor(context: Context, private val listener: UserPresenceListener) :
    ...
    private fun getPresenceFromAction(context: Context, action: String): String {
    ...
    override fun onRegister(fireStraightAway: Boolean): IntentFilter {
        ...
        if (keyguardManager != null) {
            ...
            val presence: String = if (keyguardManager.isKeyguardLocked) {
                PRESENCE_LOCKED
            } else {
                PRESENCE_UNLOCKED
            }
    ...
    fun updateAmbientMode(ambientMode: Boolean, animate: Boolean) {
        ...
        val presence: String = if (ambientMode) {
            PRESENCE_AOD
        } else {
            rawUserPresence!!.get()
        }
    ...
    private fun setUserPresence(userPresence: String, animate: Boolean, fire: Boolean) {
