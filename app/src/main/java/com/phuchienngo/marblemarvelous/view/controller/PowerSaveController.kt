...
class PowerSaveController @Inject constructor(context: Context, private val listener: PowerSaveListener) :
    ...
    private fun setSavingPower(isPowerSave: Boolean, fire: Boolean) {
