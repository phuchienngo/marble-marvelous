...
class PlutoShader : Shader {
    ...
    override fun init() {
        program = ShaderProgram(Gdx.files.internal("pluto/pluto.vert"), Gdx.files.internal("pluto/pluto.frag"))
    ...
    override fun render(renderable: Renderable) {
        ...
        program.setUniformi("u_dayMap", mRenderContext.textureBinder.bind(day.textureDescription))
        ...
        program.setUniformf("u_intensity", 1.0f)
        program.setUniformMatrix("u_modelViewTrans", mModelViewMatrix)
        program.setUniformMatrix("u_worldTrans", renderable.worldTransform)
        program.setUniformMatrix("u_normalMatrix", mNormalMatrix)
