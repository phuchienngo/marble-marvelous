...
class PlanetMask {
    ...
    private val maskShader: ShaderProgram = ShaderUtils.load("celestialbodies/planetMask")
    ...
    fun begin(camera: PerspectiveCamera, renderContext: RenderContext?) {
    ...
    fun render(renderableProvider: RenderableProvider, environment: Environment) {
    ...
    fun setRimFade(rimFadeStart: Float, rimFadeEnd: Float) {
